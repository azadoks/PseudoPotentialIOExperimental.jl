...
n_radials(::NonLocalProjector, psp::HghFile, l::Int)::Int = size(psp.h[l + 1], 1)
n_radials(::PseudoState, ::HghFile, l::Int)::Int = 0
has_quantity(::AtomicQuantityFlag, ::HghFile) = false
has_quantity(::LocalPotential, ::HghFile) = true
has_quantity(::NonLocalProjector, ::HghFile) = true
has_quantity(::NonLocalCoupling, ::HghFile) = true

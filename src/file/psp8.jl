...
n_radials(::NonLocalProjector, file::Psp8File, l::Int)::Int = file.header.nproj[l + 1]
n_radials(::PseudoState, ::Psp8File, l::Int)::Int = 0
has_quantity(::AtomicQuantityFlag, ::Psp8File) = false
has_quantity(::LocalPotential, ::Psp8File) = true
has_quantity(::NonLocalProjector, ::Psp8File) = true
has_quantity(::NonLocalCoupling, ::Psp8File) = true
has_quantity(::CoreDensity, file::Psp8File) = !isnothing(file.rhoc)
has_quantity(::PseudoValenceDensity, file::Psp8File) = !isnothing(file.rhov)
